...
'     Set default values of errors for dissociation constants (pK)
'     Default values for epK are:
'        pK0   :  0.002   CO2 solubility
'        pK1   :  0.01    Carbonate dissociation constants
'        pK2   :  0.02
'        pKb   :  0.01    Borate
'        pKw   :  0.01    Water dissociation
'        pKspa :  0.01    solubility product of Aragonite
'        pKspc :  0.01    solubility product of Calcite
'
   Cells(5, "M").Value = 0.002
   Cells(7, "M").Value = 0.01
   Cells(9, "M").Value = 0.02
   Cells(11, "M").Value = 0.01
   Cells(13, "M").Value = 0.01
   Cells(15, "M").Value = 0.01
   Cells(17, "M").Value = 0.01
Else
